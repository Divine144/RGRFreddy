...
public class JailDoorBlockItem extends SimpleGeoBlockItem {

    public JailDoorBlockItem(Block pBlock, Properties pProperties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new GeoItemRenderer<JailDoorBlockItem>(new DefaultedItemGeoModel<>(new ResourceLocation(RGRFreddy.MODID, "jail_door_be"))) {
                        @Override
