...
public class SnareBlockItem extends SimpleGeoBlockItem {


    public SnareBlockItem(Block pBlock, Properties pProperties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new GeoItemRenderer<SnareBlockItem>(new DefaultedItemGeoModel<>(new ResourceLocation(RGRFreddy.MODID, "snare_be"))) {
                        @Override
