...
public class BoxTrapBlockItem extends SimpleGeoBlockItem {

    public BoxTrapBlockItem(Block pBlock, Properties pProperties) {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.renderer == null)
                    this.renderer = new GeoItemRenderer<BoxTrapBlockItem>(new DefaultedItemGeoModel<>(new ResourceLocation(RGRFreddy.MODID, "toy_box_trap_be"))) {
                        @Override
